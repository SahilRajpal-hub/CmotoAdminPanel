  ...
  return (
    ...
    <div className='main-content' id='panel'>
      ...
      <div className='container-fluid' style={{ paddingTop: 25 }}>
        ...
        <button style={{paddingTop:"20",width:"33%",background:color(a),color:textcolor(a)}} onClick={toggleA} className='container-fluid'>Work History(Exterior)</button>
        <button style={{paddingTop:"20",width:"33%",background:color(b),color:textcolor(b)}} onClick={toggle} className='container-fluid'>Work History(Interior)</button>
        </div>
